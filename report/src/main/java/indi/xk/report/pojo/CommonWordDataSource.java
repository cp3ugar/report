...
public class CommonWordDataSource implements IMailMergeDataSource {
     ...
     */  
    public CommonWordDataSource(List<Map<String, Object>> dataList, String tableName) {  
     ...
     * @param tableName 与模板中的Name对应 
     */  
    public CommonWordDataSource(Map<String, Object> data, String tableName) {  
